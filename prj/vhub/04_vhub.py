...
pkg_ppg_num = pkg_ppg_len / 2           # 每包有多少个 PPG 数据
win_pkg_num = 15                        # 窗口显示多少个包
...
ppg_val = np.zeros(int(pkg_ppg_num), dtype=int, order='C')  # 新包中的 PPG 提取数据
...
p3 = win.addPlot(title="不同滤波参数对比", colspan=2)
