...
link('01-VariablesAndLoops', "Introduction to Python variables and loops")
...
s += "<a href='https://matterandinteractions.org/glowscript/EFH.html' target='_blank'> 13-Electric Field Hockey</a>: A game with electric challenges<br><br>"
